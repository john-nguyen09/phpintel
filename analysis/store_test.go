...
func TestStore(t *testing.T) {
	...
	document.Load()
	withTestStore("test", "TestStore", func(store *Store) {
...
func TestSearchNamespace(t *testing.T) {
	withTestStore("test", "TestSearchNamespace", func(store *Store) {
...
func TestGetClassesByScope(t *testing.T) {
	withTestStore("test", "TestGetClassesByScope", func(store *Store) {
