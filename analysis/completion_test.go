...
func TestFunctionCompletionWithNamespace(t *testing.T) {
	withTestStore("test", "TestFunctionCompletionWithNamespace", func(store *Store) {
...
func TestCompletionWithScope(t *testing.T) {
	t.Run("Class", func(t *testing.T) {
		withTestStore("Class", "CompletionWithScope-Class", func(store *Store) {
...
class TestClass {}`))
	...
	t.Run("ClassConst", func(t *testing.T) {
		withTestStore("ClassConst", "CompletionWithScope-ClassConst", func(store *Store) {
			defDoc1 := NewDocument("test1", []byte(`<?php
class TestClass1 {
	const CLASS_CONST = 1;
}
class TestClass2 {
	...
	t.Run("Method", func(t *testing.T) {
		withTestStore("Method", "CompletionWithScope-Method", func(store *Store) {
			defDoc1 := NewDocument("test1", []byte(`<?php
